...
// Variables
$available_widgets = $available_widgetAreas = $modules = $mbp_filter = $merged_filters = $mbp_current_filter = $mbp_actions = $mbp_config = $mbp_update_data = [];
...
$filepath = rtrim( str_replace( [ 'http://', 'https://' ], '', SITE_URL ), '/' );
