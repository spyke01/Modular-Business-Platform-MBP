...
//		$updateData = $fts_http->request("https://www.fasttracksites.com/versions/serialChecker.php", 'POST', array(
//			'app' => A_NAME,
//			'serial' => A_LICENSE,
//			'response' => 'json'
//		));
...
function updateMBPDatabase() {
	...
	$dbUpdates = array(
		'4.13.08.19' => array( '4.13.08.19.php' ),
		'4.13.08.28' => array( '4.13.08.28.php' ),
		'4.13.12.12' => array( '4.13.08.28.php' ), // There was a bug where this update wasn't included at one time
		'4.14.01.08' => array( '4.14.01.08.php' ),
		'4.14.01.27' => array( '4.14.01.27.php' ),
		'4.14.02.12' => array( '4.14.02.12.php' ),
		'4.14.02.28' => array(	
		...
		'4.14.03.11' => array( '4.14.03.11.php' ),
		'4.14.06.02' => array( '4.14.06.02.php' ),
		'4.14.07.11' => array( '4.14.07.11.php' ),
		'4.14.08.05' => array( '4.14.08.05.php' ),
		'4.14.11.24' => array( '4.14.11.24.php' ),
		'4.15.04.06' => array( '4.15.04.06.php' ),
		'4.15.04.27' => array( '4.15.04.27.php' ),
		'4.15.05.14' => array( '4.15.05.14.php' ),
		'4.15.09.01' => array( '4.15.09.01.php' ),
		'4.15.10.02' => array( '4.15.10.02.php' ),
		'4.16.02.23' => array( '4.16.02.23.php' ),
		'4.16.04.18' => array( '4.16.04.18.php' ),
		'4.16.06.30' => array( '4.16.06.30.php' ),
		'4.16.11.15.01' => array( '4.16.11.15.01.php' ),
		'4.16.11.15.02' => array( '4.16.11.15.02.php' ),
	);
...
//		return array( 'status' => 'error', 'message' => 'Your Serial number is not valid!' );
//	} elseif ( $updateData->expiredSerial ) {
//		return array( 'status' => 'error', 'message' => 'Your Serial number has expired, please <a href="https://www.fasttracksites.com/product/license-renewal">renew your license here</a>!' );
//	} else {
//		return downloadAndInstallUpdate( 'MBP', 1, $updateData->updateURL, A_VERSION, $updateData->latestVersion );
//	}
	return array( 'status' => 'error', 'message' => 'Updates are not available when using the public version.' );
}
...
//			$returnArray[$theme] = downloadAndInstallUpdate( $theme, 3, $upgradeURL, $themeVersion, $latestVersion );
			...
			// $returnArray[$theme] = array('status' => 'error', 'message' => "$theme does not have a theme details file!");
		}
	}
...
function downloadAndInstallUpdate($name, $type, $upgradeURL = '', $currentVersion = '', $latestVersion = '') {
	...
	*/
	...
	if (!is_dir($upgrade_folder)) mkdir($upgrade_folder);
	
	if ( empty( $upgradeURL ) ) return array( 'status' => 'error', 'message' => "No Upgrade URL was supplied for $name!" );
	...
	if ( $currentVersion < $latestVersion || isset ( $_GET['forceUpdate'] ) ) {
		...
		if ( !is_file( $updgradeFileName ) ) {
			return array( 'status' => 'error', 'message' => 'Failed to download update!' );
		} else {
			...
			return array( 'status' => 'success', 'message' => "$name Updated!" );
		}
	} else {
		return array( 'status' => 'success', 'message' => "$name is the latest version!" );
	}
}