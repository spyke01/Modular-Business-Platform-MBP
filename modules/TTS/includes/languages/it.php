...
$LANG['TABLEHEADERS_COMPANY']       = "Compa��a";
$LANG['TABLEHEADERS_EMAIL_ADDRESS'] = "Direcci�n de Correo Electr�nico";
...
// $LANG['TABLEHEADERS_TITLE'] = "T�tulo"; -- Defined under View Ticket Section
// $LANG['TABLEHEADERS_USER'] = "Usuario"; -- Defined under View Ticket Section
// $LANG['TABLEHEADERS_PROBLEM_CATEGORY'] = "Problema de la Categor�a"; -- Defined under View Ticket Section
// $LANG['TABLEHEADERS_TECHNICIAN'] = "T�cnico"; -- Defined under View Ticket Section
// $LANG['TABLEHEADERS_DATE_CREATED'] = "Fecha de Creaci�n"; -- Defined under View Ticket Section
...
//================================================ ==
/*~~General~~*/
$LANG['FORMITEMS_PASSWORD'] = "Contrase�a";
$LANG['FORMITEMS_USERNAME'] = "Nombre de Usuario";

/*~~Graphs~~*/
$LANG['FORMTITLES_GENERATE_A_CUSTOM_GRAPH'] = "Generar un Gr�fico Personalizado";
$LANG['FORMITEMS_CHOOSE_GRAPH']             = "Seleccione Gr�fico";
$LANG['FORMITEMS_GRAPH']                    = "El Gr�fico";
...
$LANG['FORMITEMS_STOP_DATE']                = "Fecha de Finalizaci�n";
$LANG['FORMITEMS_CHOOSE_GRAPH_TYPE']        = "Elija Tipo de Gr�fico";
$LANG['FORMITEMS_GRAPH_TYPE']               = "Tipo de Gr�fico";
...
// $LANG['FORMITEMS_STOP_DATE'] = "Fecha de Finalizaci�n"; -- Defined under Graphs Section
...
/*~~Graphs~~*/
$LANG['BUTTONS_CREATE_GRAPH'] = "Crear un Gr�fico";
...
/*~~Graphs~~*/
$LANG['TABS_BUILTIN_GRAPHS']      = "Incorporado en los Gr�ficos";
$LANG['TABS_SHOW_A_CUSTOM_GRAPH'] = "Mostrar un Gr�fico Personalizado";
...
$LANG['ERROR_EDIT_USER']             = "Si � verificato un errore durante l'accesso dettagli dell'utente che si sta tentando di aggiornare.";
$LANG['ERROR_ENTER_ALL_INFO']        = "Si prega di inserire tutti i dati!";
$LANG['ERROR_LOGIN_FAILED']          = "Non poteva essere loggato! N� il nome utente e la password non corrispondono o non hai validato la tua iscrizione! ";
$LANG['ERROR_PLEASE_TRY_AGAIN']      = "Please try again!";
$LANG['ERROR_USERNAME_TAKEN']        = "Il nome utente da Lei forniti � gi� stato utilizzato da qualcun altro. Scegliere un altro nome utente. ";
$LANG['ERROR_EMAIL_ADDRESS_TAKEN']   = "L'indirizzo email fornito � gi� stato utilizzato da qualcun altro. Si prega di utilizzare un altro indirizzo email. ";
...
$LANG['WARNINGS_TABLE_UPDATE']          = "Una nuova riga � stata aggiunta a questa tabella, la modifica in linea di questa nuova riga verr� disattivato fino a quando il prossimo refresh della pagina.";
$LANG['WARNINGS_NEWEST_VESION']         = "La versione di applicazione � la pi� recente. Grazie per restare aggiornati.";
$LANG['WARNINGS_OUTDATED_VESION']       = "Il tuo sistema non � in esecuzione la versione pi� recente, si prega di scaricare e installare l'ultima versione di proteggere meglio il vostro sistema.";
...
$LANG['GRAPHS_TICKETS_BY_PROBLEM_CATEGORY'] = "Tickets por Problemas en la Categor�a";
$LANG['GRAPHS_TICKETS_BY_TECHNICIAN']       = "Tickets por el T�cnico";
...
$LANG['THEMES_CHANGE_THEME_SUCCESS'] = "Il tuo tema � stato cambiato con successo.";
$LANG['THEMES_CHANGE_THEME_ERROR']   = "Si � verificato un errore durante il tentativo di cambiare il tema.";
