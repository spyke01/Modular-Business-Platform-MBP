...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	<head>
		...
		<![endif]-->
		<style>
			body { background-color: <?php echo $mbp_config['ftsmbp_theme_modern_settings_backgroundPattern']; ?>; }
	...
	<body<?php if (!empty($bodyClass)) { echo ' class="' . trim($bodyClass) . '"'; } ?>>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-sm-12<?php if (!empty($contentClass)) { echo ' ' . trim($contentClass); } ?>">
