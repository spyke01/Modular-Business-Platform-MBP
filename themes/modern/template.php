...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<body<?php if ( !empty( $bodyClass ) ) { echo ' class="' . trim( $bodyClass ) . '"'; } ?>>
		<!--[if lt IE 7]>
		...
		<div id="main-wrapper">
									...
									<ul class="nav navbar-nav pull-right right-navbar-nav">
                                        ...
                                        <li class="dropdown">
											...
											<ul class="dropdown-menu">
												<?php if ( user_access('users_edit') ) { ?><li><a href="<?php echo il($menuvar['USERS'] . '&action=edituser&id=' . $_SESSION['userid']); ?>"><i class="glyphicon glyphicon-pencil"></i> Edit Profile</a></li><?php } ?>
												<?php if ( user_access('changePassword') ) { ?><li><a href="" id="changePasswordLink"><i class="glyphicon glyphicon-wrench"></i> Change Password</a></li><?php } ?>
												<li class="divider"></li>
			...
			<div id="content-wrapper"<?php if ( !empty( $contentClass ) ) { echo ' class="' . trim( $contentClass ) . '"'; } ?>>		
		
				<?php $page->printBreadCrumbs( 'ul', '', '', '', 'breadcrumb breadcrumb-no-padding', 1 ); ?>
				<?php $page->printTemplateVar('PageContent'); ?>
				<footer>
					<?php echo parseForTagsFromArray( $mbp_config['ftsmbp_copyright'], getBuiltinTagsArray() ); ?>
		...
		<script src="<?php echo SITE_URL; ?>/node_modules/jquery_jeditable/jquery.jeditable.js"></script>
