...
<html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <!--Icons End-->
        <!--Stylesheets Begin-->
        <link rel="stylesheet" href="<?php echo SITE_URL; ?>/themes/modern/css/bootstrap.min.css" />
        <link rel="stylesheet" href="<?php echo SITE_URL; ?>/themes/modern/css/bootstrap-theme.min.css" />
        <link rel="stylesheet" href="<?php echo SITE_URL; ?>/themes/modern/css/glyphicons.css" />
    ...
    <body>
        ...
        <script src="<?php echo SITE_URL; ?>/themes/modern/js/vendor/bootstrap.min.js"></script>
